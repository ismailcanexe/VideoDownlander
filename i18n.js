(function () {
    const STRINGS = {
        tr: {
            ...
            'ui.urls_placeholder': 'Her satıra bir URL yapıştırın...',
            ...
            'status.ytdlp_downloading': "İlk kurulum: İndirme motoru GitHub'dan indiriliyor (Bu işlem boyut ve internete göre birkaç dakika sürebilir)...",
            'status.ready': 'Sistem hazır. Video linki yapıştırabilirsiniz.',
            'status.ytdlp_install_failed': 'Hata: İndirme motoru indirilemedi! İnternet bağlantınızı veya GitHub erişimini kontrol edin.',
            ...
            'toast.no_valid_youtube': 'Geçerli bir URL yok.',
            ...
            'toast.no_youtube_dl': 'Geçerli bir URL bulunamadı.',
            'toast.enter_valid_url': 'Lütfen en az bir geçerli URL girin.',
            'toast.invalid_lines_dl': '{{n}} satır atlandı (geçersiz URL).',
            ...
            'code.YT_DLP_NOT_READY_INFO': 'İndirme motoru henüz hazır değil. Birkaç saniye sonra tekrar deneyin.',
            'code.YT_DLP_NOT_READY_DL': 'İndirme motoru henüz hazır değil.',
        ...
        en: {
            ...
            'ui.urls_placeholder': 'Paste one URL per line...',
            ...
            'status.ytdlp_downloading': 'First run: downloading video engine from GitHub (may take a few minutes depending on size and connection)...',
            'status.ready': 'Ready. You can paste a video link.',
            'status.ytdlp_install_failed': 'Error: video engine could not be downloaded. Check your internet or GitHub access.',
            ...
            'toast.no_valid_youtube': 'No valid URL found.',
            ...
            'toast.no_youtube_dl': 'No valid URL found.',
            'toast.enter_valid_url': 'Please enter at least one valid URL.',
            'toast.invalid_lines_dl': '{{n}} line(s) skipped (invalid URL).',
            ...
            'code.YT_DLP_NOT_READY_INFO': 'Video engine is not ready yet. Try again in a few seconds.',
            'code.YT_DLP_NOT_READY_DL': 'Video engine is not ready yet.',
        ...
        es: {
            ...
            'ui.urls_placeholder': 'Pega una URL por línea...',
            ...
            'status.ytdlp_downloading': 'Primera ejecución: descargando el motor de video desde GitHub (puede tardar unos minutos)...',
            'status.ready': 'Listo. Puedes pegar un enlace de video.',
            'status.ytdlp_install_failed': 'Error: no se pudo descargar el motor de video. Revisa tu conexión a internet.',
            ...
            'toast.no_valid_youtube': 'No hay una URL válida.',
            ...
            'toast.no_youtube_dl': 'No se encontró una URL válida.',
            'toast.enter_valid_url': 'Ingresa al menos una URL válida.',
            'toast.invalid_lines_dl': '{{n}} línea(s) omitida(s) (URL inválida).',
            ...
            'code.YT_DLP_NOT_READY_INFO': 'El motor de video no está listo. Intenta de nuevo en unos segundos.',
            'code.YT_DLP_NOT_READY_DL': 'El motor de video no está listo.',
        ...
        fr: {
            ...
            'ui.urls_placeholder': 'Collez une URL par ligne...',
            ...
            'status.ytdlp_downloading': 'Premier lancement : téléchargement du moteur vidéo depuis GitHub (cela peut prendre quelques minutes)...',
            'status.ready': 'Prêt. Vous pouvez coller un lien vidéo.',
            'status.ytdlp_install_failed': 'Erreur : impossible de télécharger le moteur vidéo. Vérifiez votre connexion.',
            ...
            'toast.no_valid_youtube': 'Aucune URL valide.',
            ...
            'toast.no_youtube_dl': 'Aucune URL valide trouvée.',
            'toast.enter_valid_url': 'Veuillez entrer une URL valide.',
            'toast.invalid_lines_dl': '{{n}} ligne(s) ignorée(s) (URL invalide).',
            ...
            'code.YT_DLP_NOT_READY_INFO': 'Le moteur vidéo n\'est pas encore prêt. Réessayez dans quelques secondes.',
            'code.YT_DLP_NOT_READY_DL': 'Le moteur vidéo n\'est pas encore prêt.',
        ...
        it: {
            ...
            'ui.urls_placeholder': 'Incolla un URL per riga...',
            'ui.audio_only_mp3': 'Solo audio (MP3)',
            ...
            'status.ytdlp_downloading': 'Primo avvio: download del motore video da GitHub (potrebbe richiedere alcuni minuti)...',
            'status.ready': 'Pronto. Puoi incollare un link al video.',
            'status.ytdlp_install_failed': 'Errore: impossibile scaricare il motore video. Controlla la connessione a Internet.',
            ...
            'progress.downloading': 'Download in corso... {{percent}}% | Dimensione: {{size}} | Velocità: {{speed}} | Rimanente: {{eta}}',
            ...
            'toast.no_valid_youtube': 'Nessun URL valido.',
            ...
            'toast.no_youtube_dl': 'Nessun URL valido trovato.',
            'toast.enter_valid_url': 'Inserisci almeno un URL valido.',
            'toast.invalid_lines_dl': '{{n}} riga/e saltata/e (URL non valido).',
            ...
            'code.YT_DLP_NOT_READY_INFO': 'Il motore video non è ancora pronto. Riprova tra qualche secondo.',
            'code.YT_DLP_NOT_READY_DL': 'Il motore video non è ancora pronto.',
        ...
        de: {
            ...
            'ui.urls_placeholder': 'Füge eine URL pro Zeile ein...',
            ...
            'status.ytdlp_downloading': 'Erster Start: Video-Engine wird von GitHub heruntergeladen (kann einige Minuten dauern)...',
            'status.ready': 'Bereit. Du kannst einen Videolink einfügen.',
            'status.ytdlp_install_failed': 'Fehler: Video-Engine konnte nicht heruntergeladen werden. Überprüfe deine Internetverbindung.',
            ...
            'toast.no_valid_youtube': 'Keine gültige URL.',
            ...
            'toast.no_youtube_dl': 'Keine gültige URL gefunden.',
            'toast.enter_valid_url': 'Bitte gib eine gültige URL ein.',
            'toast.invalid_lines_dl': '{{n}} Zeile(n) übersprungen (ungültige URL).',
            ...
            'code.YT_DLP_NOT_READY_INFO': 'Die Video-Engine ist noch nicht bereit. Versuche es in ein paar Sekunden erneut.',
            'code.YT_DLP_NOT_READY_DL': 'Die Video-Engine ist noch nicht bereit.',
        ...
        ja: {
            ...
            'ui.urls_placeholder': '1行に1つのURLを貼り付けてください...',
            ...
            'status.ytdlp_downloading': '初回起動: GitHubからビデオエンジンをダウンロード中（数分かかる場合があります）...',
            'status.ready': '準備完了。動画リンクを貼り付けてください。',
            'status.ytdlp_install_failed': 'エラー: ビデオエンジンをダウンロードできませんでした。ネットワーク接続を確認してください。',
            ...
            'toast.no_valid_youtube': '有効なURLがありません。',
            ...
            'toast.no_youtube_dl': '有効なURLが見つかりません。',
            'toast.enter_valid_url': '有効なURLを入力してください。',
            'toast.invalid_lines_dl': '{{n}} 行がスキップされました（無効なURL）。',
            ...
            'code.YT_DLP_NOT_READY_INFO': 'ビデオエンジンがまだ準備できていません。数秒後にもう一度お試しください。',
            'code.YT_DLP_NOT_READY_DL': 'ビデオエンジンの準備が完了していません。',
        ...
        zh: {
            ...
            'ui.urls_placeholder': '每行粘贴一个 URL...',
            ...
            'status.ytdlp_downloading': '首次运行：正在从 GitHub 下载视频引擎 (可能需要几分钟)...',
            'status.ready': '准备就绪。您可以粘贴视频链接了。',
            'status.ytdlp_install_failed': '错误：无法下载视频引擎。请检查您的网络连接。',
            ...
            'toast.no_valid_youtube': '没有有效的 URL。',
            ...
            'toast.no_youtube_dl': '未找到有效的 URL。',
            'toast.enter_valid_url': '请输入至少一个有效的网址。',
            'toast.invalid_lines_dl': '跳过 {{n}} 行（无效的 URL）。',
            ...
            'code.YT_DLP_NOT_READY_INFO': '视频引擎尚未准备好，请稍后再试。',
            'code.YT_DLP_NOT_READY_DL': '视频引擎尚未准备好。',
        ...
        ru: {
            ...
            'ui.urls_placeholder': 'Вставьте по одному URL на строку...',
            ...
            'status.ytdlp_downloading': 'Первый запуск: загрузка видеодвижка с GitHub (может занять несколько минут)...',
            'status.ready': 'Готово. Можно вставлять ссылки.',
            'status.ytdlp_install_failed': 'Ошибка: не удалось скачать видеодвижок. Проверьте интернет-соединение.',
            ...
            'toast.no_valid_youtube': 'Нет валидного URL.',
            ...
            'toast.no_youtube_dl': 'Не найдено валидных URL.',
            'toast.enter_valid_url': 'Введите хотя бы один валидный URL.',
            'toast.invalid_lines_dl': '{{n}} строк пропущено (неверный URL).',
            ...
            'code.YT_DLP_NOT_READY_INFO': 'Видеодвижок еще не готов. Попробуйте через пару секунд.',
            'code.YT_DLP_NOT_READY_DL': 'Видеодвижок еще не готов.',
